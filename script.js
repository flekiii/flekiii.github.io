const translations = {
  en: {
    ...
    supportTitle: "Support my <span class=\"support-key\">work</span>.",
    supportText: "If you like what I'm building and want to help me keep <span class=\"support-key\">developing</span>, you can <span class=\"support-key\">support the projects</span> directly.",
    supportButton: "SUPPORT FLEKIII",
    supportNote: "Support link opens Monobank Jar.",
    supportExtra: "Every <span class=\"support-key\">contribution</span> helps me spend more time <span class=\"support-key\">building</span>.",
    backTop: "Back to top ↑",
...
projectVpnDesc: "Власний VPN-проєкт, орієнтований на безпечний та гнучкий доступ до мережі.",
    ...
    supportTitle: "Підтримай мою <span class=\"support-key\">роботу</span>.",

const translations = {
  en: {
    ...
    about1: "I'm <strong>flekiii</strong>, a 15-year-old independent developer who learns through practice by creating my own projects.",
    about2: "This site is my public space where I document my path: from mastering the basics to building the large-scale system I imagine.",
    about3: "I want to give both people and myself freedom on the internet, so everyone who wants freedom can have it.",
    about4: "I am doing this not only for freedom and for people. I come from a poor family, and I want to bring freedom not only to the internet but also to the life of my family and to my own life. I want to reach great heights and understand that I really can create something. I do not have support, and no one believes in me, so I have to prove that I can do this, that I am capable of a lot — so I can be proud of myself and know that I gave people something they enjoy.",
    about5: "Mainly, I am doing all of this for money and my own freedom.",
  ...
  uk: {
    ...
    about1: "Я — <strong>flekiii</strong>, 15-річний незалежний розробник, який навчається на практиці, створюючи власні проєкти.",
    about2: "Цей сайт — мій публічний простір, де я документую свій шлях: від опанування основ до створення масштабної системи, яку я собі уявляю.",
    about3: "Я хочу дати як людям, так і собі свободу в інтернеті, щоб усі, хто хоче свободи, отримали її.",
    about4: "Я роблю це не тільки заради свободи та людей. Я з бідної сім'ї й хочу дати свободу не тільки в інтернеті, а й у житті своїй сім'ї та самому собі. Я хочу досягнути висот і розуміти, що я справді можу щось зробити. У мене немає підтримки, у мене ніхто не вірить, тому я повинен довести, що я це можу, що я можу багато чого — щоб я пишався собою і розумів, що дав людям те, що їм подобається.",
        about5: "В основному я займаюся цим усім заради грошей і своєї свободи.",

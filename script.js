const translations = {
  ...
  uk: {
    ...
    currentLearningDesc: "Поточний фокус — вивчення основ JavaScript.",
    currentBuilding: "РОЗРОБКА",
    ...
    goalComputerText: "Оновити основну машину для більших збірок і майбутньої інфраструктури.",
...
const projectCatalog = {
  ...
  vpn: {
    ...
    name: "VPN",
    status: "PLANNED",
    page: "https://flekiii.github.io/vpn/?v=2",
  ...
  browser: {
    ...
    status: "PLANNED",
    page: "https://flekiii.github.io/browser/?v=2",
  ...
  search: {
    ...
    name: "Search Engine",
    status: "PLANNED",
    page: "https://flekiii.github.io/search/?v=2",
  ...
  email: {
    ...
    name: "Email Service",
    status: "PLANNED",
    page: "https://flekiii.github.io/email/?v=2",
  ...
  cloud: {
    ...
    name: "Cloud Drive",
    status: "PLANNED",
    page: "https://flekiii.github.io/cloud/?v=2",
  ...
  music: {
    ...
    name: "Music Platform",
    status: "PLANNED",
    page: "https://flekiii.github.io/music/?v=2",
  ...
  games: {
    ...
    name: "Game Platform",
    status: "PLANNED",
    page: "https://flekiii.github.io/games/?v=2",
  ...
  as: {
    ...
    name: "AS",
    status: "PLANNED",
    page: "https://flekiii.github.io/as/?v=2",
  ...
  flekibard: {
    ...
    name: "Flekibard",
    status: "PLANNED",
    page: "https://flekiii.github.io/flekibard/?v=2",
  ...
  flassi: {
    ...
    name: "flassi",
    status: "PLANNED",
    page: "https://flekiii.github.io/flassi/?v=2",
  ...
  trust: {
    ...
    name: "TRUSTmoney",
    status: "PLANNED",
    page: "https://flekiii.github.io/trust/?v=2",
  ...
  network: {
    ...
    status: "PLANNED",
    page: "https://flekiii.github.io/network/?v=2",
  ...
  "trueos-pc": {
    ...
    name: "TRUE OS · PC",
    status: "PLANNED",
    page: "https://flekiii.github.io/true-os/?v=2",

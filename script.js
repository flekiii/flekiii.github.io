const translations = {
  en: {
    ...
    currentLearningDesc: "Building real projects while learning the language.",
    currentBuilding: "BUILDING",
    currentBuildingDesc: "Turning the messenger idea into a real product.",
    currentPlanning: "PLANNING",
    currentPlanningDesc: "Connecting platforms, services and TRUE OS into one ecosystem.",
    currentPlatformDesc: "My main development environment.",
    roadmapTitle: "Roadmap",
    roadmap2026: "JavaScript learning, Flekibard development and foundation work for the ecosystem.",
    roadmap2027: "Expand the ecosystem with new platforms, services and deeper project development.",
    roadmapFutureTitle: "Full ecosystem",
    roadmapFuture: "Bring the major platforms and TRUE OS directions together into one independent ecosystem.",
    profileEyebrow: "DEVELOPER PROFILE",
    profileRole: "15 years old · Independent Developer",
    profileText: "Building an independent digital ecosystem from the ground up.",
    ecosystemTitle: "flekiii Ecosystem",
    ...
    devlogTitle: "Dev Log",
    devlogDate: "LAST 3 DAYS",
    devlogHeadline: "Learning almost all of the JavaScript basics.",
    devlogText: "The current work is not counted as a project. It is the learning phase that prepares the skills needed for the projects ahead.",
    goalsTitle: "Support Goals",
    goalServers: "Servers",
    goalServersText: "Build the infrastructure needed to run future services.",
    goalDomain: "Own domain",
    goalDomainText: "Get a dedicated domain for a separate main site.",
    goalNetwork: "TRUST Network certificates",
    goalNetworkText: "Work toward the certificates and infrastructure needed to officially launch my own network.",
    goalComputer: "Better computer",
    goalComputerText: "Upgrade the main development machine for larger builds and future infrastructure.",
    about1: "I'm <strong>flekiii</strong>, a 15-year-old independent developer who is learning by building.",
    about2: "Right now I'm focused on learning JavaScript, understanding how software works and turning what I learn into real code instead of leaving ideas on paper.",
    about3: "I want to build a large independent ecosystem: a messenger, AI, media and game platforms, search, cloud, finance, networking and my own operating-system direction for three target devices.",
    about4: "I like the idea of technology that gives people freedom, customization and control. This site is my public place to document the path from learning the basics to building the bigger system I imagine.",
  ...
  uk: {
    ...
    modalEyebrow: "ПРОЄКТ",
    currentlyTitle: "Зараз",
    currentLearning: "ВИВЧАЮ",
    currentLearningDesc: "Створюю реальні проєкти та паралельно вивчаю мову.",
    currentBuilding: "РОЗРОБЛЯЮ",
    currentBuildingDesc: "Перетворюю ідею месенджера на реальний продукт.",
    currentPlanning: "ПЛАНУЮ",
    currentPlanningDesc: "Об'єдную платформи, сервіси та TRUE OS в одну екосистему.",
    currentPlatformDesc: "Моє основне середовище розробки.",
    roadmapTitle: "Roadmap",
    roadmap2026: "Вивчення JavaScript, розробка Flekibard та фундамент для екосистеми.",
    roadmap2027: "Розширення екосистеми новими платформами, сервісами та поглиблення розробки.",
    roadmapFutureTitle: "Повна екосистема",
    roadmapFuture: "Об'єднати основні платформи та напрями TRUE OS в одну незалежну екосистему.",
    profileEyebrow: "ПРОФІЛЬ РОЗРОБНИКА",
    profileRole: "15 років · Незалежний розробник",
    profileText: "Будую власну цифрову екосистему з нуля.",
    ecosystemTitle: "Екосистема flekiii",
    ...
    tabEcosystem: "Екосистема",
    tabAbout: "Про мене",
    liveLabel: "ЗАРАЗ ВИВЧАЮ",
    liveText: "Останні кілька днів мій головний фокус — вивчення основ JavaScript.",
    nextLabel: "ДАЛІ",
    nextText: "Після JavaScript — Node.js та основи backend-розробки.",
    roadmapNowLabel: "ЗАРАЗ",
    roadmapNow: "Вивчити основи JavaScript і закріплювати їх реальною практикою.",
    roadmapNextLabel: "ДАЛІ",
    roadmapNext: "Перейти до Node.js та основ backend-розробки.",
    roadmapLaterLabel: "ПІЗНІШЕ",
    roadmapLaterTitle: "Проєкти та екосистема",
    roadmapLater: "Повернутися до глибшої розробки проєктів із сильнішою базою програмування та backend.",
    ...
    devlogTitle: "Dev Log",
    devlogDate: "ОСТАННІ 3 ДНІ",
    devlogHeadline: "Вивчив майже всі основи JavaScript.",
    devlogText: "Поточне навчання не рахується окремим проєктом. Це етап підготовки навичок, потрібних для майбутніх проєктів.",
    goalsTitle: "Цілі підтримки",
    goalServers: "Сервери",
    goalServersText: "Створити інфраструктуру, на якій зможуть працювати майбутні сервіси.",
    goalDomain: "Власний домен",
    goalDomainText: "Придбати окремий домен для майбутнього основного сайту.",
    goalNetwork: "Сертифікати TRUST Network",
    goalNetworkText: "Працювати над сертифікатами та інфраструктурою, необхідними для офіційного запуску власної мережі.",
    goalComputer: "Кращий комп'ютер",
    goalComputerText: "Оновити основну машину для більш великих збірок і майбутньої інфраструктури.",
    about1: "Я <strong>flekiii</strong>, 15-річний незалежний розробник, який навчається через створення.",
    about2: "Зараз мій головний фокус — JavaScript: зрозуміти мову, навчитися нормально писати код і перетворювати те, що вивчаю, на реальні речі, а не залишати ідеї лише на папері.",
    about3: "Я хочу побудувати велику незалежну екосистему: месенджер, AI, медіа- та ігрові платформи, пошук, хмару, фінанси, мережу та власний напрям операційних систем для трьох цільових пристроїв.",
    about4: "Мені подобається технологія, яка дає свободу, кастомізацію та контроль. Цей сайт — моє публічне місце, де можна побачити шлях від вивчення бази до великої системи, яку я хочу побудувати.",
    currentBuildingDesc: "Зараз головний фокус не прив'язаний до одного проєкту — поточний етап присвячений вивченню JavaScript.",
    currentPlanningDesc: "Великі ідеї проєктів залишаються в планах, поки я будую потрібні для них навички та фундамент."
};

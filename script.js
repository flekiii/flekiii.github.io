const translations = {
  en: {
    ...
    goalPhone: "New phone",
    goalPhoneText: "My phone broke and the display barely works. I use my phone to test mobile versions of code and programs, so I now need to find about ≈ 13,000 UAH for a new one. I want to buy an iPhone 11 Pro Max because my current Redmi 12C is too weak and sometimes freezes, while an iPhone would also let me immediately test iOS versions of programs and code. That will be very useful in the near future, so the first money from donations will go toward this.",
    goalServers: "Servers",
...
projectVpnDesc: "Власний VPN-проєкт, орієнтований на безпечний та гнучкий доступ до мережі.",
    ...
    goalPhoneText: "У мене розбився телефон, і дисплей ледве працює. Завдяки телефону я перевіряю мобільні версії кодів та програм, тому тепер мені потрібно десь знайти ≈ 13 000 грн на новий. Я хочу купити iPhone 11 Pro Max. Чому саме його: зараз у мене Redmi 12C, він надто слабкий і моментами зависає. Також на iPhone я одразу зможу перевіряти iOS-версії програм та кодів, а це дуже знадобиться в найближчому майбутньому. Тому перші гроші з донатів підуть саме на це.",
    goalServers: "Сервери",
